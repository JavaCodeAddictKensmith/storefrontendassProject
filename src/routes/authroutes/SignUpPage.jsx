    ...
    return (
        <>
            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-100">
                <div className="w-full max-w-md rounded-[10px] bg-white pb-8 pt-3 shadow-md md:min-w-[530px] lg:min-w-[530px]">
                    {/* <button className="absolute right-4 top-4 text-lg text-gray-500">&times;</button> */}
                    <div className="item-end mb-3 mt-0 flex w-full justify-end px-3">
                        {/* <div> */}
                        <img
                            src={close}
                            alt="logo"
                                ...
                                <div>
                                    <div className="flex h-[48px] w-full flex-col rounded-md border-[0.6px] border-gray-300 bg-[#F9F9FA] px-3 focus:outline-none">
                                        ...
                                        {formik.touched.password && formik.errors.password ? (
                                            <div className="mb-5 mt-[8px] flex w-[300px] text-xs text-red-600 md:w-[424px]">
